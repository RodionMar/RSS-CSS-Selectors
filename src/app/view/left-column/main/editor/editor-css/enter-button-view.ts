...
import type InputView from './editor-css-body/input/input-view';

export default class EnterButtonView extends View {
  constructor(
    input: InputView,
    window: EditorView,
